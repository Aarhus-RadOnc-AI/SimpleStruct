import numpy as np
from filters.get_edge_of_structure import get_edge_of_structure
...
def calculate_added_path_length(reference_structure: sitk.Image, other_structure: sitk.Image):
    ...
    gt_edge = get_edge_of_structure(reference_structure)
    pred_edge = get_edge_of_structure(other_structure)
