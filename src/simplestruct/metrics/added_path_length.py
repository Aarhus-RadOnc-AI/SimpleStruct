...
def calculate_added_path_length(reference_structure: sitk.Image, other_structure: sitk.Image):
    ...
    gt_edge = generate_edge_of_structure(sitk.GetArrayFromImage(reference_structure))
    pred_edge = generate_edge_of_structure(sitk.GetArrayFromImage(other_structure))
